    ...
    return (
        <section className={className}>
            <header>
                ...
                <p className="mt-1 text-sm text-gray-600">{t('profile.password.description')}</p>
            </header>

            <form onSubmit={updatePassword} className="mt-6 space-y-6">
                <div>
                    <InputLabel htmlFor="current_password" value={t('fields.currentPassword')} />
                ...
                <div>
                    <InputLabel htmlFor="password" value={t('fields.newPassword')} />
